...
//            else if let dog = dog {
////                chatViewController.userdog = dog
//                let dogs = [matchdog, dog]
//                chatViewController.matchedDogs = dogs
//                self.navigationController?.present(chatViewController, animated: true, completion: nil)
...
////                            let chatViewController = ChatViewController()
//                            let chatViewController = ChatViewController()
//                            chatViewController.conversation = newConversation
//                            self.navigationController?.present(chatViewController, animated: true, completion: nil)
...
////                        let chatViewController = ChatViewController()
//                        let chatViewController = ChatViewController()
//                        chatViewController.conversation = convo
//                        chatViewController.dbmessages = convo["messages"] as! [PFObject]
//                        self.navigationController?.present(chatViewController, animated: true, completion: nil)
